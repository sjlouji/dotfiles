...
# (run setup-captures for full setup including the Desktop watcher LaunchAgent)
...
# Enable HiDPI display modes (needs sudo — skip silently if unavailable)
